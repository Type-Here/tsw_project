...
<div class="newsletter-container">
    ...
    <div class="newsletter-header">
        <hr>
        <h1>Calore garantito (dai videogiochi)</h1>
        <h3>Il freddo ti dà i <span style="color: rgb(147, 169, 209); font-weight: bold"><em>brividi?</em></span><br>
            I nostri sconti invernali ti faranno tremare... di gioia!</h3>
        <hr>
    </div>
    ...
    <div class="newsletter-footer">
        <hr>
        <h3>Cosa aspetti?<br>
            Riscalda il tuo inverno con i nostri giochi con lo sconto del <strong>10%</strong> e il codice</h3>
        <h1 style=" color: #0a78f5">BRIVIDI10!</h1>
        <hr>
    </div>
</div>